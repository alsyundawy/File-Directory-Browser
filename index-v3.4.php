...
// Redirect URL if berkas contains URL-encoded slashes (%2F) to preserve clean slashes
if (isset($parsedUrl['query']) && preg_match('/%2f/i', $parsedUrl['query'])) {
    $needsRedirect = true;
}
                ...
                <?php else: ?>
                    ...
                    foreach ($parts as $index => $part) {
                        ...
                        if ($index === $partCount - 1) {
                            ...
                            echo '<a href="' . e(queryUrl(['berkas' => $cumulativePath])) . '">' . e($part) . '</a>';
                        }
                    }
                    ?>
                <?php endif; ?>
